...
const PostModal = () => {
  ...
  return (
    <div className="fixed w-full h-full top-0 left-0 z-20 bg-black flex overflow-y-scroll scrollable-element">
      <div className="w-full m-2 mt-0">
        <div className="flex flex-col w-full bg-[radial-gradient(ellipse_at_top,#1f2c3b,_black)] shadow-[0px_0px_59px_#111720c2]">
          ...
          <h1 className="md:text-6xl text-2xl font-bold text-center m-auto md:mt-40 mt-16">Upgrade to Premium</h1>
        </div>
        ...
        <div className="m-auto w-fit md:mt-16 mt-3">
          <div className="w-fit bg-gray-800 flex p-[2px] rounded-full items-center gap-1 m-auto">
            <div className={`px-2 py-1 ${prem && "bg-black"} cursor-pointer rounded-full flex items-center gap-1`} onClick={() => setPrem(true)}>Annual <span className="text-xs px-2 py-[2px] bg-[#00251a] rounded-full">Best Value</span></div>
            <div className={`px-2 py-1 ${!prem && "bg-black"} cursor-pointer rounded-full`} onClick={() => setPrem(false)}>Monthly</div>
          </div>
          <div className="flex gap-8 md:mt-10 mt-5 md:flex-row flex-col">
            {/* Premium plans */}
            <div className={`bg-[#202327] p-[32px] rounded-xl ${plan.type === "Basic" ? "border-2 border-[#1d9bf0]" : "border-none"} min-h-[150px] min-w-[230px] xl:min-w-[330px]`} onClick={() => setPlan({ type: "Basic" })}>
              ...
              <button className="text-base text-black rounded-full font-bold bg-white w-full py-1 mt-3 md:hidden block">Subscribe</button>
        ...
        <div className="mx-auto max-w-[980px] w-full mt-16 pb-[300px]">
        ...
        <div className="fixed xl:flex hidden justify-center bottom-0 left-0 bg-black w-full p-4 border-t border-[#202327] min-h-[100px]">
          <div className="min-w-56 max-w-[475px] mr-4">
            <div className="text-xl">{plan.type}</div>
            <div>
              <div className="mt-4"><span className="text-4xl font-bold">{prem ? "₹6,800" : "₹650"}</span> / {prem ? "year" : "month"}</div>
              <div className="mt-2">Billed {prem ? "annually" : "monthly"}</div>
            </div>
          </div>
          <div className="min-w-56 max-w-[475px] w-full mr-4">
            <button className="mb-3 w-full px-4 py-2 bg-[#1d9bf0] rounded-full font-bold">Subscribe & Pay</button>
