...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-full h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center md:gap-8 gap-2">
            ...
            <h1 className="font-bold md:text-xl text-base">Media Settings</h1>
          </div>
          <button className="py-0 md:py-2 px-2 md:px-4 rounded-full bg-white text-black font-bold" onClick={onClose}>
            Save
          </button>
        </div>
        <div className="w-full md:w-[600px] h-full md:h-[600px] flex items-center">
          <Image
            src={previewURL}
            alt=""
            width={600}
        ...
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center gap-2 md:gap-8">
            ...
            >
              ...
              <div className="md:block hidden">Original</div>
            </div>
            <div
              className="flex items-center gap-2 cursor-pointer"
            ...
            >
              ...
              <div className="md:block hidden">Wide</div>
            </div>
            <div
              className="flex items-center gap-2 cursor-pointer"
            ...
            >
              ...
              <div className="md:block hidden">Square</div>
            </div>
          </div>
          <div
